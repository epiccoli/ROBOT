...
//Define IR objects
#define 	IR_FRONT_BOT_LEFT_OUT		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C0, LONG_RANGE, 5
#define 	IR_FRONT_BOT_LEFT_IN		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C1, LONG_RANGE, 5
#define 	IR_FRONT_TOP_LEFT_OUT		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C2, LONG_RANGE, 5
#define 	IR_FRONT_TOP_LEFT_IN		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C3, LONG_RANGE, 5
#define 	IR_SIDE_LEFT_FRONT			MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C4, SHORT_RANGE, 5
#define 	IR_SIDE_LEFT_ARMS			MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C5, SHORT_RANGE, 5

#define 	IR_FRONT_BOT_RIGHT_OUT		MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C0, LONG_RANGE, 5
#define 	IR_FRONT_BOT_RIGHT_IN		MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C1, LONG_RANGE, 5
#define 	IR_FRONT_TOP_RIGHT_OUT		MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C2, LONG_RANGE, 5
#define 	IR_FRONT_TOP_RIGHT_IN		MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C3, LONG_RANGE, 5
#define 	IR_SIDE_RIGHT_FRONT			MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C4, SHORT_RANGE, 5
#define 	IR_SIDE_RIGHT_ARMS			MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C5, SHORT_RANGE, 5
