...
#define 	IR_SIDE_LEFT_ARMS			MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C4, SHORT_RANGE, 5
...
#define 	IR_SIDE_RIGHT_ARMS			MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C4, SHORT_RANGE, 5
