...
//Define IR objects
#define 	IR_FRONT_BOT_LEFT_OUT		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C3, LONG_RANGE, 5
#define 	IR_FRONT_BOT_LEFT_IN		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C1, LONG_RANGE, 5
#define 	IR_FRONT_TOP_LEFT_OUT		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C9, LONG_RANGE, 5
#define 	IR_FRONT_TOP_LEFT_IN		MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C7, LONG_RANGE, 5
#define 	IR_SIDE_LEFT_FRONT			MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C5, SHORT_RANGE, 5
#define 	IR_SIDE_LEFT_ARMS			MUX_L_SIG, MUX_L_S0, MUX_L_S1, MUX_L_S2, MUX_L_S3, C15, SHORT_RANGE, 5

#define 	IR_FRONT_BOT_RIGHT_OUT		MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C1, LONG_RANGE, 5
#define 	IR_FRONT_BOT_RIGHT_IN		MUX_R_SIG, MUX_R_S0, MUX_R_S1, MUX_R_S2, MUX_R_S3, C4, LONG_RANGE, 5
...
#define 	IR_SIDE_LEFT_BACK			A4, SHORT_RANGE, 5
#define 	IR_IN_LEFT					A5, SHORT_RANGE, 5
#define 	IR_IN_MID					A6, SHORT_RANGE, 5
#define 	IR_IN_RIGHT					A7, SHORT_RANGE, 5
#define 	IR_SIDE_RIGHT_BACK			A8, SHORT_RANGE, 5
